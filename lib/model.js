...
var App = Model.extend({
  ...
  sync: function(method, model, options) {
    ...
    var overrides = Object.assign({}, options);
    ...
    this.loadPackageJson(function(err, data) {
      ...
      done(null, Object.assign(data, overrides));
    });
  },
  ...
  serialize: function() {
    ...
    for (let key of Object.getOwnPropertyNames(this._children)) {
      res[key] = this[key].serialize()
    }
    for (let key of Object.getOwnPropertyNames(this._collections)) {
      res[key] = this[key].serialize();
    }
    return res;
  }
